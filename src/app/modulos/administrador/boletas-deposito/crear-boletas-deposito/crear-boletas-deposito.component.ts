...
@Component({
  selector: 'app-crear-boletas-deposito',
  templateUrl: './crear-boletas-deposito.component.html',
  styleUrls: ['./crear-boletas-deposito.component.css']
})
export class CrearBoletasDepositoComponent implements OnInit, AfterViewInit {
