...
@Component({
  selector: 'app-gestionar-transacciones-boleta',
  templateUrl: './gestionar-transacciones-boleta.component.html',
  styleUrls: ['./gestionar-transacciones-boleta.component.css']
})
export class GestionarTransaccionesBoletaComponent implements OnInit, OnDestroy {
