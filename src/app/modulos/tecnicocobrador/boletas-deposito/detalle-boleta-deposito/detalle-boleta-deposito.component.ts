...
@Component({
  selector: 'app-detalle-boleta-deposito',
  templateUrl: './detalle-boleta-deposito.component.html',
  styleUrls: ['./detalle-boleta-deposito.component.css']
})
export class DetalleBoletaDepositoComponent implements OnInit, OnDestroy {
