...
@Component({
  selector: 'app-detalles-instalaciones',
  templateUrl: './detalles-instalaciones.component.html',
  styleUrls: ['./detalles-instalaciones.component.css']
})
export class DetallesInstalacionesComponent implements OnInit, OnDestroy {
