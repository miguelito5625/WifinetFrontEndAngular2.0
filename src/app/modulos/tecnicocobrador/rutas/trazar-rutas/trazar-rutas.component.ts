...
@Component({
  selector: 'app-trazar-rutas',
  templateUrl: './trazar-rutas.component.html',
  styleUrls: ['./trazar-rutas.component.css']
})
export class TrazarRutasComponent implements OnInit, AfterViewInit, OnDestroy {
